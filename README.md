...
- （将来）**回答済み**の結果を **PDF でエクスポート**（1 人 1 ファイル・jsPDF。§6・**未実装**）
- （将来）研修結果からOJTで確認すべきポイントを整理する（§7・**未実装**）
